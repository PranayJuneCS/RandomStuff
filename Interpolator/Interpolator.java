...
public class Interpolator {
	...
	public static void getMod(boolean workingMod) {
		try {
			...
			terminate = true;
			System.out.println("You have a " + e.toString() + ". Goodbye.");
		}
	}

	public static void getPoints(boolean workingMod) {
		try {
			System.out.println("Enter the number of points for your polynomial.");
	...
	//Make more efficient later using Euclid's EGCD algorithm
	...
	public static void hello() {
		...
		if (response.equals("yes") || response.equals("y")) {
			...
			System.out.println("You are now working over the real numbers.");
		}
	}
